...
# Armazenar memória do código streamlit
...
# Modificando a página que eu estou
...
def main():
    ...
    if st.session_state.pagina_central_email =='home':
       ...
       texto_arquivo = st.session_state.texto_lista_editar 
       pag_adicionar_nova_lista(nome_lista, texto_arquivo)
